...
body {
  min-height: 100vh;
  min-width: 100vw;
  background-image: -webkit-linear-gradient(45deg, #3908ff 0%, #ffb199 100%);
  background-image: -moz-linear-gradient(45deg, #3908ff 0%, #ffb199 100%);
  background-image: linear-gradient(45deg, #3908ff 0%, #ffb199 100%);
  display: flex;
...
<body>
 <section id="signup-box">
  ...
  <form id="signup-form">
    ...
    <input id="signup-name" type="text" name="name" placeholder="Harry"><br>
    <label for="email">Email</label><br>
    <input id="signup-email" type="email" name="email" placeholder="andrew27@gmail.com"><br>
 ...
 <script>
        function validateSignupForm(){
            ...
            //if password is not empty and length must not be less than 5 characters
